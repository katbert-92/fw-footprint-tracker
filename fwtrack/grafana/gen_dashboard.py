...
def build_dashboard(
    ...
    return {
        ...
        # Named for what separates the two dashboards rather than for the
        # project: the folder already says which project, and everything here
        # is per region, which is exactly what the overview does not show.
        "title": "Regions",
        "description": (
